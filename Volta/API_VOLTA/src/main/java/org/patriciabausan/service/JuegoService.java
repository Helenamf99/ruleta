...
public class JuegoService {
    ...
    public Usuario eliminarYNotificar(Integer id) {
        ...
        // Si quieres borrar también sus partidas (cuidado con las claves foráneas)
        // partidaRepository.deleteByUsuarioId(id); // necesitarías ese método en PartidaRepository

        usuarioRepository.delete(usuario);

        // Lógica de notificación (ej. imprimir log, enviar email...)
        System.out.println("Notificación: Usuario " + usuario.getNombreUsuario() + " ha sido eliminado.");
