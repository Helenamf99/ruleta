CREATE DATABASE  IF NOT EXISTS `abp` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `abp`;
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '41c15d62-456e-11f1-91be-0829b3091344:1-94';
...
INSERT INTO `categorias` VALUES (1,'Geografia',''),(2,'Historia',''),(3,'Musica',''),(4,'Informatica',''),(5,'Entretenimiento',''),(6,'Deportes',''),(7,'nueva','nombre');
...
CREATE TABLE `partidas` (
  ...
  CONSTRAINT `partidas_ibfk_1` FOREIGN KEY (`id_jugador`) REFERENCES `usuarios` (`id`)
...
CREATE TABLE `preguntas` (
  ...
  KEY `id_cat` (`id_cat`),
  CONSTRAINT `preguntas_ibfk_1` FOREIGN KEY (`id_cat`) REFERENCES `categorias` (`id_cat`) ON DELETE CASCADE
...
CREATE TABLE `usuarios` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_name` (`nombre_usuario`)
...
INSERT INTO `usuarios` VALUES (1,'Administrador','Admin123.','2026-05-21','danielivina01@gmail.com',1,NULL,NULL,0,NULL);
...
-- Dump completed on 2026-05-23 11:33:58
